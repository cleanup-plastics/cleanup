...
const token =
  "pk.eyJ1IjoiZWx2aWFzaSIsImEiOiJja2w1ZjFhNDgwbms4MzBwNmpmcTUzaXU5In0.tyY-4o-vyzl93U7XLFjekQ";
          ...
          {this.state.selectedEvent ? (
            ...
            >
              <div>
                ...
                <button
                  onClick={() =>
                    this.toggleEventDetails(this.state.selectedEvent)
                  }
                >
                ...
                <p>
                  {this.state.toggled && (
                    <p>
                      {this.state.selectedEvent.description} <br />
                      <b>Location:</b> {this.state.selectedEvent.location}{" "}
                      <br />
                      <>
                        <button>
                          <Link to={`/events/${this.state.selectedEvent._id}`}>
                            Save Event
                          </Link>
                        </button>
                      </>
